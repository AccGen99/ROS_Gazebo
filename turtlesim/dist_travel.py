# Program to stop turtle after travelling a certain distance

#!/usr/bin/env python

from ROS_Course_1.src.asgn_1.turtlesim_pose import pose_callback
import rospy
...
def move(speed, distance):
   #declare a Twist message to send velocity commands
    ...
    velocity_message.linear.x = x0

    distance_moved = 0.0
    loop_rate = rospy.Rate(10) # we publish the velocity at 10 Hz (10 times a second)    

    #task 2. create a publisher for the velocity message on the appropriate topic.  
    velocity_publisher = rospy.Publisher('turtle1/cmd_vel', Twist, queue_size=5)
